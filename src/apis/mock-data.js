export const mockData = {
  board: {
    _id: "board-id-01",
    title: "Fullstack",
    description: "Project Trello Clone",
    type: "public", // 'private'
    ...
    columns: [
        ...
        cards: [
          {
            ...
            cover:
              "https://image.tienphong.vn/w1000/Uploaded/2024/lce-ljvqj/2024_01_23/han-so-hee3-7389.jpg",
      ...
      },
      {
        ...
        cardOrderIds: ["card-id-04-placerholder-card"],
        cards: [
          {
            _id: "card-id-04-placerholder-card",
            boardId: "board-id-01",
            columnId: "column-id-03",
